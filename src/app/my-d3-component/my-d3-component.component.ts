...
@Component({
  ...
  styleUrls: ['./my-d3-component.component.scss'],
...
export class MyD3ComponentComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    let link: d3.Selection<SVGPathElement, any, SVGGElement, unknown>,
      node: d3.Selection<SVGTextElement, d3.HierarchyNode<any>, SVGGElement, unknown>;
